#ifndef DEF_ElectronL1Study_dumpHLT
#define DEF_ElectronL1Study_dumpHLT
...
class ElectronL1Study_dumpHLT : public edm::EDAnalyzer {
 public:
  explicit ElectronL1Study_dumpHLT(const edm::ParameterSet&);
