#ifndef DEF_ElectronJetsL1Study
#define DEF_ElectronJetsL1Study
...
class ElectronJetsL1Study : public edm::EDAnalyzer {
 public:
  explicit ElectronJetsL1Study(const edm::ParameterSet&);
  ~ElectronJetsL1Study();
