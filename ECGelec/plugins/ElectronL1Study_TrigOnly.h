#ifndef DEF_ElectronL1Study_TrigOnly
#define DEF_ElectronL1Study_TrigOnly
...
class ElectronL1Study_TrigOnly : public edm::EDAnalyzer {
 public:
  explicit ElectronL1Study_TrigOnly(const edm::ParameterSet&);
  ~ElectronL1Study_TrigOnly();
